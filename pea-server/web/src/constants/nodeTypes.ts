...
export const PEA_NODE_TYPES: PeaNodeTypeDef[] = [
  ...
  { kind: 'image', label: '图片', icon: '🖼️', color: '#FD79A8', category: 'input', desc: '图片素材' },
  { kind: 'video', label: '视频', icon: '🎬', color: '#1fa2dc', category: 'input', desc: '视频素材' },
  ...
  { kind: 'generate', label: '生成', icon: '⚡', color: '#1fa2dc', category: 'generate', desc: 'AI 生成图像' },
  ...
  { kind: 'world3d', label: '3D 世界', icon: '🌐', color: '#06b6d4', category: 'generate', desc: '3D 场景' },
